...
public:
	...
	static void ensure_handler_installed_for_thread(const char* thread_description);
...
protected:
	...
	static void Handler(unsigned int errorCode, std::exception* pInfo);
...
protected:
	...
	friend void win32_exception::Handler(unsigned int errorCode, std::exception* pInfo);
