...
{	
		...
		, input_sample_format_(input_sample_format)
	{
		...
		{	
			auto resampler = av_audio_resample_init(output_channels, input_channels, output_sample_rate, 							input_sample_rate, output_sample_format, input_sample_format,16, 10, 0, 0.8);
