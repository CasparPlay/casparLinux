...
safe_ptr<frame_producer> create_color_producer(const safe_ptr<core::frame_factory>& frame_factory,
									const core::parameters& params)
{
	...
	return create_producer_print_proxy(make_safe<color_producer>(frame_factory, color2));
}
