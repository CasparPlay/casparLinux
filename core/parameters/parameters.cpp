...
void parameters::replace_placeholders(const std::wstring& placeholder, const std::wstring& replacement)
{
	for (size_t i = 0; i < params_.size(); ++i)
	{
		...
		{
			boost::replace_all(param, placeholder, boost::to_upper_copy(replacement));
...
std::wstring parameters::get(const std::wstring& key, const std::wstring& default_value) const
{
